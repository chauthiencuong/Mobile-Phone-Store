        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductVariants_Configurations_ConfigurationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPromotions_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "GoogleId", "ImageUser", "Name", "Password", "Phone", "Role", "Username" },
                values: new object[] { 1, "admin@gmail.com", null, null, "admin", "$2a$10$p02oE31dZeCWLzz4liGCruRp.EE8BXrbxgIlgFjV3WF/rOZpPW25q", "1234567890", "Admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPromotions_ProductVariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariants_ConfigurationId",
                table: "ProductVariants",
